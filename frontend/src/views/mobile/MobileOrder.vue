  ...
  const products = ref([
    {
      ...
      price: 4.5,
      image:
        'https://images.unsplash.com/photo-1485808191679-5f86510681a2?q=80&w=400',
      category: 'Coffee',
      desc: 'Fresh espresso with creamy milk and caramel.'
    },
    {
      id: 2,
      ...
      price: 5.25,
      image:
        'https://images.unsplash.com/photo-1515823064-d6e0c04616a7?q=80&w=400',
      category: 'Tea',
      desc: 'Premium grade matcha whisked with oat milk.'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      category: 'Food',
      desc: 'Angus beef with cheddar and secret sauce.'
    }
  ])
...
<template>
  <v-app class="bg-grey-lighten-5">
          ...
          >
            <div>
              ...
              <p class="text-caption text-grey-lighten-1">
                Order directly from your phone and we'll bring it to your table.
              </p>
            </div>
          </v-card>
        </v-container>
          ...
          <v-row>
            ...
            >
              <v-card
                flat
                rounded="xl"
                class="border overflow-hidden product-card"
              >
                <div class="d-flex pa-3">
                  ...
                  <div class="ml-4 flex-grow-1">
                    ...
                    <div class="text-caption text-grey mb-2 line-clamp-2">
                      {{ product.desc }}
                    </div>
                    <div class="d-flex justify-space-between align-center">
                      <span
                        class="text-subtitle-1 font-weight-black text-primary"
                      >
                        ${{ product.price }}
                      </span>
                      <v-btn
      ...
      <template v-if="page === 'cart'">
        <v-container>
          ...
          <v-card
            ...
            :key="item.id"
            flat
            class="border rounded-xl pa-3 mb-3"
          >
          ...
          <v-card
            flat
            class="mt-6 pa-4 rounded-xl border-dashed bg-primary-lighten-5"
          >
      ...
      <template v-if="page === 'tracking'">
        <v-container class="text-center pt-10">
          ...
          <p class="text-grey mb-8">
            Relax, we are preparing your order for
    ...
    <v-bottom-navigation grow v-if="page !== 'tracking'">
      <v-btn @click="page = 'home'">
        <v-icon>mdi-home</v-icon>
        Menu
      </v-btn>
      <v-btn @click="page = 'tracking'">
