<template>
  <v-container fluid class="pa-0">
    ...
    <div class="mt-4 px-4 d-flex align-center">
      <div class="d-flex overflow-x-auto no-scrollbar flex-grow-1">
        <v-chip-group
          v-model="selectedCategory"
          mandatory
          selected-class="bg-primary text-white"
        >
          <v-chip value="All Items" class="px-6">All Items</v-chip>
          <v-chip
      ...
      <v-row v-else class="mt-2">
        ...
        >
          <v-card flat class="product-card rounded-xl border">
            <v-img :src="product.image_url" height="160" cover class="bg-grey-lighten-3">
